...
class alluvial:
    ...
    #     column_details_df[skewer_params["random_tag"] + "_xs_straight"] = (
    ...
    #     ]
    #     column_details_df[skewer_params["random_tag"] + "_xs"] = (
    #         column_details_df.apply(
    ...
    #         )
    #     )
    #     column_details_df[skewer_params["random_tag"] + "_ys"] = (
    #         column_details_df.apply(
    ...
    #     column_details_df[skewer_params["random_tag"] + "_nl_ellipse_center_xs"] = (
    #         column_details_df.apply(
    ...
    #     ].to_list()
    #     column_details_df[skewer_params["random_tag"] + "_nl_ellipse_center_ys"] = (
    #         column_details_df.apply(
    ...
    #         )
    #         df_number_line_selection_ellipse_triangles["x0"] = (
    ...
    #             )
    #         )
    #         df_number_line_selection_ellipse_triangles["x1"] = (
    #             df_number_line_selection_ellipse_triangles.apply(
    #                 lambda row: skewer_params["pcp_circle_radius"]
    #                 * np.cos(row["angle1"])
    #                 * 0.8
    ...
    #             )
    #         )
    #         df_number_line_selection_ellipse_triangles["x2"] = (
    #             df_number_line_selection_ellipse_triangles.apply(
    #                 lambda row: skewer_params["pcp_circle_radius"]
    ...
    #             )
    #         )
    #         df_number_line_selection_ellipse_triangles["y0"] = (
    #             df_number_line_selection_ellipse_triangles.apply(
    ...
    #             )
    #         )
    #         df_number_line_selection_ellipse_triangles["y1"] = (
    #             df_number_line_selection_ellipse_triangles.apply(
    #                 lambda row: skewer_params["pcp_ellipse_height"]
    #                 * np.sin(row["angle1"])
    #                 * 0.75
    ...
    #             )
    #         )
    #         df_number_line_selection_ellipse_triangles["y2"] = (
    #             df_number_line_selection_ellipse_triangles.apply(
    #                 lambda row: skewer_params["pcp_ellipse_height"]
    ...
    #             )
    #         )
    #         df_number_line_selection_ellipse_triangles["xs"] = (
    #             df_number_line_selection_ellipse_triangles[
    #                 ["x0", "x1", "x2"]
    #             ].values.tolist()
    #         )
    #         df_number_line_selection_ellipse_triangles["ys"] = (
    #             df_number_line_selection_ellipse_triangles[
    #                 ["y0", "y1", "y2"]
    #             ].values.tolist()
    #         )
    #         df_number_line_selection_ellipse_triangles["fill_color"] = (
        ...
        class rb_elliptical_buttons:
            ...
            def get_cds_dict(self, skewer_params, col_names, curr_selection):
                ...
                df["fill_color"] = df.apply(
                    lambda row: (
                        skewer_params["rb_fill_color_selected"]
        ...
        class rb_button_labels:
            ...
            def get_cds_dict(self, skewer_params, col_names, curr_selection):
                ...
                df["text_color"] = df.apply(
                    lambda row: (
                        skewer_params["rb_fill_color_unselected"]
                        if row["col_names"] == curr_selection["color_col_name"]
...
class cim:
    ...
    class cim_overlap:
        def __init__(
            ...
            # self.background_glyph_vars = ["top"]
        ...
        def get_cds_dict(
            ...
            for col_name in col_names:
                ...
                df_cim_overlap_temp = (
                    df_cim_overlap[["cim_overlap", "cim_overlap_individual", "count"]]
                    .groupby(level=0)
                    .agg(
                ...
                # )
                df_cim_overlap_temp["top"] = df_cim_overlap_temp["cim_overlap"].sum()
                df_cim_overlap_temp["bottom"] = 0
                df_cim_overlap_temp["fill_color"] = "gray"
