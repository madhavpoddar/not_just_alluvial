...
def set_skewer_params(df, col_names):
    ...
    skewer_params["heightspx_cim"] = int(skewer_params["heightspx_alluvial"] / 4.8)
    ...
    skewer_params["rb_ellipse_y"] = -0.055
    skewer_params["rb_labels_y"] = -0.0675
    skewer_params["rb_ellipse_height"] = 0.06
    skewer_params["rb_ellipse_bondary_halfheight"] = (
        skewer_params["rb_ellipse_height"] * 0.54
    )
    ...
    # Dynamic Parameters
    skewer_params["bar_width"] = 0.006 * len(col_names)
    skewer_params["rb_ellipse_width"] = min(
    ...
    skewer_params["rb_ellipse_bondary_halfwidth"] = (
        skewer_params["rb_ellipse_width"] * 0.54
    )
    skewer_params["cim_bar_width"] = min(
        skewer_params["rb_ellipse_bondary_halfwidth"] * 1.6, 0.9
    )
